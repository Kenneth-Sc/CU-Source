      ...
      Container(
        ...
        borderRadius: BorderRadius.circular(12),
          ...
          child:
            Column(
              children: [
                Text('Contact Information\n', style: TextStyle(fontSize: (MediaQuery.of(context).size.width < 1000) ? 24 : 50, fontWeight: FontWeight.bold)),
                ...
                Row(
                  ...
                  TextButton(onPressed: () => launch("tel://5617796438"), child: Text('561-779-6438\n', style: TextStyle(fontSize: (MediaQuery.of(context).size.width < 1000) ? 16 : 38, fontWeight: FontWeight.normal), textAlign: TextAlign.center)),
                ],),
                TextButton(
                onPressed: () {
                   final email = Uri(
                ...
                child: Text('Maria.Rodezno@aol.com\n', 
  ...
  Widget build(BuildContext context) {
   ...
   Positioned(
    ...
    child: RichText(
            ...
            text: TextSpan(
              text: 'CONTACT US\n',
              style: TextStyle(fontWeight: FontWeight.bold, fontStyle: FontStyle.italic, fontSize: (MediaQuery.of(context).size.width < 1000) ? 30 : 60, color: Colors.black, fontFamily: "Century Gothic"),
