...
Widget buildIndicator() => AnimatedSmoothIndicator(
  ...
  effect: const SlideEffect(activeDotColor: Colors.blueAccent),
);
    ...
    return Scaffold(
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          Text('  - © 2024 Cliffside Upholstery -', style:  TextStyle(fontSize: MediaQuery.of(context).size.width < 1000 ? 11 : 14)),
          ],
        ),
      ),
      appBar: AppBar(
        backgroundColor: Color.fromRGBO(198, 198, 198, 1),
        title: Center(child: new InkWell(child: Text(widget.title, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 21.0)), onTap: () => launch('https://www.cliffsideupholstery.com'),)),
        actions: <Widget>[
          PopupMenuButton(
...
Positioned(
        ...
        width: (MediaQuery.of(context).size.width < 500 || MediaQuery.of(context).size.height < 500) ? 120 : 300,
        height: (MediaQuery.of(context).size.height < 500 || MediaQuery.of(context).size.width < 500) ? 120 : 300,
        child: Opacity(
          opacity: 0,
  ...
  //   // left: (MediaQuery.of(context).size.width < 1000) ? (MediaQuery.of(context).size.width / 6.90) : (MediaQuery.of(context).size.width / 6.50),
  //   // top: (MediaQuery.of(context).size.height < 1000) ? (MediaQuery.of(context).size.height / 3.25) : (MediaQuery.of(context).size.height / 3.125),
  //   left: (MediaQuery.of(context).size.width < 500) ? (MediaQuery.of(context).size.width / 1) : (MediaQuery.of(context).size.width / 20),
  //   top: (MediaQuery.of(context).size.height < 500) ? (MediaQuery.of(context).size.height /  2.75) : (MediaQuery.of(context).size.height / 2.75),
      ...
      Container(
        ...
        borderRadius: BorderRadius.circular(12),
          ...
          child:
            Column(
              children: [
                Text('Contact Information\n', style: TextStyle(fontSize: (MediaQuery.of(context).size.width > 400 && MediaQuery.of(context).size.height > 400) ? 30 : 18, fontWeight: FontWeight.bold, decoration: TextDecoration.underline), textAlign: TextAlign.center),
                Text('14A Dempsey Avenue, Edgewater, NJ, 07020\n', style: TextStyle(fontSize: (MediaQuery.of(context).size.width > 400 && MediaQuery.of(context).size.height > 400) ? 30 : 18, fontWeight: FontWeight.normal), textAlign: TextAlign.left,),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                  Icon(Icons.phone_rounded, size: (MediaQuery.of(context).size.width > 400 && MediaQuery.of(context).size.height > 400) ? 26 : 18 , color: Colors.green),
                  TextButton(onPressed: () => launch("tel://2012242302"), child: Text('201-224-2302', style: TextStyle(fontSize: (MediaQuery.of(context).size.width > 400 && MediaQuery.of(context).size.height > 400) ? 30 : 18, fontWeight: FontWeight.normal), textAlign: TextAlign.center)),
                ],),
                TextButton(
                onPressed: () {
                   final email = Uri(
                      scheme: 'mailto',
                      path: 'MariaRodezno@aol.com',
                      query: 'subject=&body=',
                    );
                  launch(email.toString());}, 
                child: Text('\nMariaRodezno@aol.com', 
                  style: TextStyle(fontSize: (MediaQuery.of(context).size.width > 400 && MediaQuery.of(context).size.height > 400) ? 30 : 18, fontWeight: FontWeight.normal),
                  textAlign: TextAlign.center))
              ],),
        ),
    ],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Center(child: new InkWell(child: Text('Cliffside Upholstery', textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 21.0)), onTap: () => launch('https://www.cliffsideupholstery.com'),)),
        actions: <Widget>[
          IconButton(
      ...
      Opacity(
        ...
        borderRadius: const BorderRadius.only(
          ...
          child: RichText(
            ...
            text: const TextSpan(
              text: '\nCliffside Upholstery will transform your space, a trusted name in the business for over four decades. ',
              style: const TextStyle(fontWeight: FontWeight.normal, fontStyle: FontStyle.normal, fontSize: 25.0, color: Colors.black, fontFamily: "Century Gothic"),
            children: <TextSpan> [
            ...
            style: TextStyle(fontWeight: FontWeight.normal, color: Colors.black, fontFamily: "Century Gothic", fontSize: 25.0, fontStyle: FontStyle.normal)),
            ]),
            selectionColor: Colors.black,
          ),
        ),
...
class GalleryMenu extends StatefulWidget {
  const GalleryMenu({super.key});

  @override
  State<GalleryMenu> createState() => _MyGalleryMenuState();
}

class _MyGalleryMenuState extends State<GalleryMenu>  with SingleTickerProviderStateMixin {
  late AnimationController _controller = AnimationController(vsync: this);
  int rotate = 0;
  final controller = CarouselController();
  int activeIndex = 0;
...
void previous() => controller.previousPage();
  ...
  Widget build(BuildContext context) {
    ...
    Container(
          ...
          //color: Colors.amber,
          image: const DecorationImage(
            image: AssetImage('assets/images/pexels-olena-bohovyk-18468859.jpg'),
            fit: BoxFit.cover,
        ),
        border: Border.all(
          width: 1.05,
      ...
      Opacity(
        ...
        borderRadius: const BorderRadius.only(
          ...
          child: RichText(
            textAlign: TextAlign.center,
            text:  TextSpan(
              text: '\nCliffside Upholstery has accumulated quite a body of work through our decades of business. As such, we\'ve photographed almost all of our pieces and have quite a gallery of pieces to display. The carousel below has some samples from our catalogue, so enjoy.\n',
