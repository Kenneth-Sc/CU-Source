  ...
  Widget build(BuildContext context) {
    ...
    Container(
      ...
      borderRadius: BorderRadius.circular(12),
          ...
          height:55,
          child: const Text(
            'Cliffside Upholstery has over 45 years of excellence, and we\'re continuing to create and provide the highest quality designs.',
